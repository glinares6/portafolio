  ...
  return (
    <main>
      <div className="flex justify-center">
        <div className="grid grid-cols-[250px,1fr] justify-center	 py-7  px-5 w-11/12">
          ...
          <div className="h-full grid grid-cols-3 grid-rows-[repeat(4,1fr)]">
            ...
            <ListSmartphone picture="/img/01-smartphone/11-honor-x7a.webp" title={`Smartphone HONOR X7A 6.7" 6GB 128GB<br/> 50MP + 5MP + 2MP + 2MP Silver`} from="Por Plaza Vea" offer1={899} offer2={729} current={689} />
