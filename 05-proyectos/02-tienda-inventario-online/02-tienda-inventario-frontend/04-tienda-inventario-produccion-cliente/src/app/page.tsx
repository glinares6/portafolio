...
export default function Page() {
  ...
  const { authState, cuentaState }: any = useContext(UseContext);
                  ...
                  >
                    <li className="py-3 w-11/12  ">
                      <a href="#">
                        ...
                        Rem excepturi blanditiis, aperiam quibusdam, esse
                        expedita en ab nosbis vel numquam laborum quam
                        assumenda. Itaque adipisci veniam, vitae similique
                        possimus sed.
                      </a>
                      {authState ? (
                        <h1>valor true 1</h1>
