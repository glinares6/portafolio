                ...
                <div className="flex flex-col  items-center " >
                    <div className="flex item-center w-11/12  border-green-500 border-2 max-sm:flex-col  ">
                        ...
                        <div className=" flex  flex-col justify-start   border-red-700 border-2  w-1/3 max-sm:w-full">
                            <button onClick={handleSection} className=" pr-3 py-3 hidden cursor-pointer  max-sm:block max-sm:flex max-sm:justify-end max-sm:transition max-sm:duration-300 max-sm:ease-linear   ">
                            ...
                            <div className={display ? ' block max-sm:ransition-transform max-sm:duration-300  max-sm:linear  max-sm:h-[400px] overflow-hidden  ' : '  block max-sm:ransition-transform max-sm:duration-300 max-sm:linear max-sm:h-[0px] overflow-hidden	'}>
                                <ul className={`flex flex-col items-center justify-center w-full`}>
                                    ...
                                    <li className="py-3 "><a href="#">Impresora</a></li>
                                </ul>
                            </div>
                    ...
                    <div className="col-span-2 text-2xl border-blue-800 border-2 w-11/12">todos estan aqui {search && <h1>{search}</h1>}</div>
